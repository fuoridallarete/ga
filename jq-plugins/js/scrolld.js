(function ($) {
    $.fn.scrolld = function (options) {
        ...
        /*CHANGE IT!!!*/var scrolldNavBar = 'fixed-nav'; // Set id name of fixed web navbar
        /*CHANGE IT!!!*/var scrolldMobileNavBar = 'fixed-nav'; // Set id name of fixed mobile navbar
        ...
        var
        /*I CAN CHANGE THIS SETTINGS- CHECK DOCUMENTATION TO DO IT*/
        defaults = {
            /// Set Web Settings
            scrolldDistance: scrolldPre,
            scrolldDistanceMin: scrolldPre,
            scrolldSpeed: speed18,
